...
| --- | --- | --- | --- | --- |
| likely | digit inside a word | `2nd` | 39 | ed in 2006 as well as … 91.8 percent of 2nd-lien deals originated in 2006 have been |
| likely | digit inside a word | `2a` | 26 | n, JPM_WM00302979, Hearing Exhibit 4/13-2a; 4/2010 “Evaluation of Federal Regulato |
| likely | digit inside a word | `3d` | 23 | ame time. 13 Goldstein v. SEC, 451 F.3d 873 (D.C. Cir. 2006). 14 The financi |
...
| likely | digit inside a word | `8B` | 78 | 91 Govt $8B 2005  |
| likely | digit inside a word | `4B` | 78 |  $24B $4B Home Equity 4%  |
| likely | digit inside a word | `8b` | 83 | -E_00102515, at 3, Hearing Exhibit 4/13-8b (citing a Long Beach quality assurance  |
| likely | digit inside a word | `1PPD` | 134 | y. Some points for the Option ARM MTA >=1PPD: • $105mm in Nonaccrual  |
| likely | digit inside a word | `1Q` | 135 |  We should address selling 1Q [first quarter] as soon as we can befor |
| likely | digit inside a word | `1mm` | 371 |  DB [Deutsche Bank] buy from us the $13.1mm of BB rated CDO liabilities HBK  |
| likely | digit inside a word | `1Bln` | 395 | t [profit and loss] month, making over $1Bln that month.”1569 The $3.7 bill |
| likely | digit inside a word | `7bn` | 416 | oans inventory decreased from $11bn to $7bn. ... subprime loans decreased  |
| likely | digit inside a word | `5bn` | 416 | prime loans decreased from $6.3bn to $1.5bn, Second Liens decreased from $1.5bn to  |
| likely | digit inside a word | `5Bln` | 446 | ) form and run that long against our $3.5Bln in mezzanine subprime shorts.  |
| likely | digit inside a word | `1bp` | 291 | unately we are still failing by 1bp [basis point], without any stress runs  |
| likely | digit inside a word | `3bn` | 416 |  subprime loans decreased from $6.3bn to $1.5bn, Second Liens decreased from  |
| likely | digit inside a word | `8bn` | 416 | nd dent] Loans remained unchanged at $0.8bn.”1655 This analysis indicates that, in |
| likely | digit inside a word | `5bb` | 424 | cM ahon, GS M BS-E-012502371 (“Bought 1.5bb of sn baa3 risk from harbinger.”); 3/1/ |
| likely | digit inside a word | `2s` | 439 | ail from Mr. Sparks to Mr. Viniar, “CDO^2s,” GS MBS-E-009747489. 1771 6/8/200 |
...
| likely | digit inside a word | `6d` | 77 | 808312-324 at 314, Hearing Exhibit 4/13-6d. 188 Id. at 315 [emphasis in origin |
| likely | digit inside a word | `6a` | 79 | 03227058-67 at 60, Hearing Exhibit 4/13-6a. 193 Id. at 66 [emphasis in origina |
...
| likely | digit inside a word | `F2F` | 157 |  12/6/2006 WaMu Home Loan Credit Risk F2F, JPM_WM02583396-98, Hearing Exhibit 4/1 |
| likely | digit inside a word | `8K` | 245 | n 7/30/2010 Fremont General Corporation 8K filing with the SEC). 937 2006 Frem |
| likely | digit inside a word | `1d` | 277 | , Director at S&P, Hearing Exhibit 4/23-1d. 1044 10/20/2006 email from Michae |
| likely | digit inside a word | `3Q` | 283 | ana to Yuri Yoshizawa, and others, “RE: 3Q Market Coverage-CDO,” Hearing Exhibit 4 |
| likely | digit inside a word | `3a` | 355 | i at Paulson to Ananth Krishnamurthy at 3a Investors, PAULSON ABACUS 0234459. 1332 |
| likely | digit inside a word | `1a` | 378 |  Date 3rd Downgrade: Date Class A-1a AAA: March 15, 2007 A+: Feb. 5 |
| likely | digit inside a word | `1b` | 378 | 2008 CC: August 19, 2009 Class A-1b AAA: March 15, 2007 B-: Feb. 5 |
| likely | digit inside a word | `2FLLC` | 380 | rary.com/Fitch+Rates+Orion+2006-1,+Ltd.%2FLLC.-a0146274727; 6/9/2006 “$292.5 Million  |
| likely | digit inside a word | `9B` | 394 | [profit and loss]: . . . derivatives +5.9B), GS MBS-E-009724276, Hearing Exhibit 4 |
| likely | digit inside a word | `4BN` | 425 | ed 500bp on the week. Business covered $4BN in single names. –Noted a lot o |
| likely | digit inside a word | `2BB` | 426 | stic job for the desk by bringing in $1.2BB [billion] in A-rated single names today |
| likely | digit inside a word | `7b` | 428 | tgage] department is short ABX AAA [$]8.7b[illion], splitting among ABS/Alt A/prim |
| likely | digit inside a word | `2B` | 429 | ld but I’m thinking buy back $1-2B, not $8B.”1716 Mr. Sparks replied to M |
| likely | digit inside a word | `9BB` | 429 |  warehouse. The bulk of these shorts ($9BB) are on the AAA index, so the downside  |
| likely | digit inside a word | `5x` | 446 | e implied losses at the AAA level are 2.5x higher than the implied losses  |
...
| possible | possible rn/m confusion | `concerned` | 45 |  worst. If a regulator became concerned about the safety or soundness of a fina |
| possible | possible rn/m confusion | `earnings` | 43 | rect and large negative impact on [its] earnings in fiscal 2008.”); see also, Viral V. A |
| possible | possible rn/m confusion | `California` | 61 |  115 Long Beach was located in Anaheim, California, had a network of loan centers across t |
| possible | possible rn/m confusion | `internally` | 72 | hief Risk Officer Jim Vanasek expressed internally concern about the unsustainable rise in |
| possible | possible rn/m confusion | `warned` | 17 | l CDO trader, Greg Lippmann, repeatedly warned and advised his Deutsche Bank colleague |
| possible | possible rn/m confusion | `warning` | 72 | tgage underwriting and appraisal staff, warning of a bubble in housing prices and encou |
| possible | possible rn/m confusion | `International` | 130 | eakdown,” prepared by Nomura Securities International Inc., http://www.scribd.com/doc/1960690 |
| possible | possible rn/m confusion | `warnings` | 73 | s even decline. There have been so many warnings of a Housing Bubble that we all |
| possible | possible rn/m confusion | `morning` | 136 | commendation[.]”464 On Tuesday morning, February 20, 2007, Mr. Beck replied wi |
| possible | possible rn/m confusion | `returns` | 24 | d the firm’s capital to gain investment returns for the firm itself rather than for its |
| possible | possible rn/m confusion | `Warner` | 277 | 45 10/26/2006 email from Ernestine Warner to Robert Pollsen, Hearing Exhibit 4/23 |
| possible | possible rn/m confusion | `earned` | 25 | eputation as a safe investment. Lenders earned fees for bundling the home loans into p |
| possible | possible rn/m confusion | `Barnes` | 262 | S Group was Frank Raiter and then Susan Barnes; and the head of the Global CDO Group w |
| possible | case break inside a word | `eAp` | 57 |  Mutual, JPMorgan Chase, OTS, the FDIC, eAppraiseIT, Lenders Service Inc., Moody’s, |
| possible | possible rn/m confusion | `garnered` | 11 |  for higher prices on Wall Street. They garnered higher prices because higher risk meant |
| possible | possible rn/m confusion | `Modernization` | 22 | 9, also known as the Financial Services Modernization Act, P.L. 106-102. Some banks had alrea |
| possible | possible rn/m confusion | `alternatives` | 29 |  typically allowed to choose among four alternatives: (1) paying the fully amortizing amount |
| possible | possible rn/m confusion | `Earnings` | 67 | uity] of at least 18%, and average EPS [Earnings Per Share] growth of at least 13%.” 148 |
| possible | possible rn/m confusion | `turnover` | 193 | seven years, and that “[t]his amount of turnover is very unusual for an institution of t |
| possible | possible rn/m confusion | `earning` | 24 | rtgage until the homeowner paid it off, earning its profit from the interest rates and  |
| possible | possible rn/m confusion | `governance` | 116 | y Guidance documents “A strong governance process will be important as peak loss  |
| possible | possible rn/m confusion | `Internally` | 145 | s that lasted more than six months. 499 Internally, it considered a number of issues relat |
...
| possible | possible rn/m confusion | `internet` | 60 | ple, originated loans over the phone or internet; borrowers did not need to meet in pers |
| possible | possible rn/m confusion | `Bernardino` | 93 | nd, Stockton, Sacramento, Riverside/San Bernardino, Memphis, Miami/Fort Lauderdale, Bakers |
| possible | possible rn/m confusion | `discernable` | 105 | t the Downey and Montebello offices, no discernable actions were taken by WaMu management t |
| possible | possible rn/m confusion | `nongovernment` | 143 | er, GSEs are Congressionally chartered, nongovernment owned financial institutions created fo |
| possible | possible rn/m confusion | `burnt` | 145 | got a good economic outcome and haven’t burnt any bridges for the future.”). 500  |
| possible | possible rn/m confusion | `Cornerstone` | 195 | ed (LSI). 695 Calling the move “Project Cornerstone,” WaMu fired all of its residential sta |
| possible | possible rn/m confusion | `consternation` | 210 | s subprime lending. To the surprise and consternation of the FDIC, the OTS Regional Director  |
| possible | possible rn/m confusion | `Abernathy` | 242 | F.S.B. One of the executives – S. Blair Abernathy, former CFO – has agreed to settle the  |
| possible | case break inside a word | `atIg` | 244 | mberg.com/apps/news?pid=newsarchive&sid=atIgi9otRZ3k. 932 3/2006 Fremont General |
| possible | possible rn/m confusion | `Kharnak` | 286 | il from Edward Tang (Citigroup) to Lina Kharnak (S&P), Hearing Exhibit 4/23-8.  |
| possible | possible rn/m confusion | `cornerstone` | 297 | the data was that it would be a cornerstone for marketing, that S&P touted the size |
| possible | possible rn/m confusion | `Kornfeld` | 303 | 6/28/2007 email from Yi Zhang to Warren Kornfeld and others, Hearing Exhibit 4/23-39. 11 |
| possible | possible rn/m confusion | `burning` | 313 | ing longer than this and we are burning them out. We have had a couple of resig |
| possible | possible rn/m confusion | `warns` | 317 | es/publications/fiff_04. 1203 “FBI warns of mortgage fraud ‘epidemic’,” CNN.com  |
| possible | possible rn/m confusion | `burnishing` | 354 | d total origination numbers as a way of burnishing their reputations, attracting top talen |
